...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/withered-term-4a30
```

A live public deployment of this template is available at [https://withered-term-4a30.templates.workers.dev](https://withered-term-4a30.templates.workers.dev)
